...
namespace WebService {
    public class ApplicationSvc : IApplicationSvc {
        ...
        public BusinessLayer.WorkApplication AddApplication(AuthToken at, string applicationName, string applicationDescription, string applicationCreator, string applicationPackageUrl, string applicationWorkIntent, string applicationNamespace, int applicationVersion = 1) {
        ...
        public BusinessLayer.DeviceAppInstallation RegisterDeviceToApp(AuthToken at, int applicationId, int deviceId) {
        ...
        public void DeregisterDeviceToApp(AuthToken at, int applicationId, int deviceId) {
            new AuthSvc().AuthUser(at, -1, deviceId);
