...
namespace WebService {
    ...
    public interface IWorkOrderSvc {
        [OperationContract]
        BusinessLayer.WorkOrder CreateWorkOrder(AuthToken at, int deviceId, int applicationId, String commPackageJson);

        [OperationContract]
        void CancelWorkOrder(AuthToken at, int workOrderId);
