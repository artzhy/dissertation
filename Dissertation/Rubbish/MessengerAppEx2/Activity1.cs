...
namespace MessengerAppEx2 {
    [Activity(Label = "MessengerAppEx2", MainLauncher = true, Icon = "@drawable/icon")]
    public class Activity1 : Activity, ISvcComm {
        int count = 1;

        Messenger ReplyMessenger = new Messenger(new MessengerAppEx2.Activity1.IncomingHandler());
