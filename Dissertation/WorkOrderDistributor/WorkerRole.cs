...
namespace WorkOrderDistributor {
    public class WorkerRole : RoleEntryPoint {
        ...
        const string CancelledWorkOrdersQName = "cancelledworkorders";

        // QueueClient is thread-safe. Recommended that you cache 
        // rather than recreating it on every request
        QueueClient NewWorkOrders;
        QueueClient CompletedWorkOrders;
        QueueClient CancelledWorkOrders;
        ...
        public override bool OnStart() {
            ...
            if (!namespaceManager.QueueExists(CancelledWorkOrdersQName)) {
                namespaceManager.CreateQueue(CancelledWorkOrdersQName);
            }
            ...
            CancelledWorkOrders = QueueClient.CreateFromConnectionString(connectionString, CancelledWorkOrdersQName);
            IsStopped = false;
            return base.OnStart();
        }
